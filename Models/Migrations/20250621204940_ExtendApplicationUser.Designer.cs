...
namespace Models.Migrations
{
    ...
    [Migration("20250621204940_ExtendApplicationUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Entities.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("Models.Entities.ProjectMedium", b =>
                {
            ...
            modelBuilder.Entity("Models.Entities.RolePermission", b =>
                {
                    b.Property<int>("PermissionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Models.Entities.Technology", b =>
                {
            ...
            modelBuilder.Entity("Models.Entities.UserSkill", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Models.Entities.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Models.Entities.RolePermission", b =>
                {
                    ...
                    b.HasOne("Models.Entities.ApplicationRole", "Role")
                        .WithMany("RolePermissions")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProjectTechnology", b =>
                {
                    b.HasOne("Models.Entities.Project", null)
                        .WithMany()
                        .HasForeignKey("ProjectId")
                        .IsRequired()
                        .HasConstraintName("project_technology_project_fk");

                    b.HasOne("Models.Entities.Technology", null)
                        .WithMany()
